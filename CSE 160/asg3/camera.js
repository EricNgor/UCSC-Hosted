...
class Camera {
    constructor() {
        ...
        this.f = new Vector3();
        this.fov = 90.0;
        this.eye = new Vector3([0,6,0]);
        this.at = new Vector3([1,6,0]);
    ...
    update() {
        this.viewMatrix.setLookAt(
            this.eye.elements[0], this.sneaking ? this.eye.elements[1]-.1 : this.eye.elements[1], this.eye.elements[2], 
            this.at.elements [0], this.sneaking ? this.at.elements[1]-.1 : this.at.elements[1], this.at.elements [2],
            this.up.elements [0], this.up.elements [1], this.up.elements [2]
        );
    ...
    gravity() {
        ...
        if (this.eye.elements[1] <= 2.00) {
            this.v = 0;
        }
        else {
            this.v = this.v < -9.8 ? this.v : this.v - 0.012;
        }
    }   
