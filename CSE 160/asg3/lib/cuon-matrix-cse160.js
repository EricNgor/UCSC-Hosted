...
class Vector3 {
    ...
    div(scalar) {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        this.elements = this.elements.map(el => el / scalar);
        // Don't delete the return statement.
        return this;
    };
    ...
    static dot(other1, other2) {
        ...
        for (let i = 0; i < other1.elements.length; ++i) {
          let a = other1.elements[i];
          let b = other2.elements[i];
          d += (!(isNaN(a) && isNaN(b)) ? (a * b) : 0);
        }
        // Don't delete the return statement.
        return d;
    }
    ...
    magnitude() {
        // Insert your code here.
        let inner = 0;
        this.elements.forEach(el => inner += !isNaN(el) ? el ** 2 : 0);
        let m = Math.sqrt(inner);
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        ...
        this.elements = this.elements.map(el => el / (!isNaN(el) ? mag : 1));
        // Don't delete the return statement.
        return this;
    };
}
